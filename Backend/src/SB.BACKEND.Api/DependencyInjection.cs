...
public static class DependencyInjection
{
    ...
    {
        var settings =
            configuration.GetRequiredSection(JwtSettings.SECTION_NAME).Get<JwtSettings>()
        ...
        services.AddAuthorization(options =>
        {
            foreach (var permission in Permissions.All)
                options.AddPolicy(
                    ...
                    policy =>
                    {
                        policy.RequireClaim(Permissions.CLAIM_TYPE, permission);
                    }
                );
            options.AddPolicy(
                "SupportAdmin",
            ...
            options.AddPolicy(
                ...
                policy =>
                {
                    policy.RequireRole("Admin", "Administrador", "Analista");
                }
            );
        });
        return services;
