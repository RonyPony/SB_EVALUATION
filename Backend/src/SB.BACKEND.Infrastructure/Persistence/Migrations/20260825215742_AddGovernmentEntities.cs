...
namespace SB.BACKEND.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddGovernmentEntities : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                {
                    return new
                    {
                        ...
                        PoderDelEstado = table.Column<string>(
                            type: "nvarchar(100)",
                            maxLength: 100,
                            nullable: false
                        ),
                        Sector = table.Column<string>(
                            type: "nvarchar(150)",
                            maxLength: 150,
                            nullable: false
                        ),
                ...
                {
                    {
                        ...
                        "Allows GOVERNMENT_ENTITY.VIEW.",
                        true,
                        "GOVERNMENT_ENTITY.VIEW",
                        "GOVERNMENT_ENTITY.VIEW",
                        null,
                    },
                    {
                        ...
                        "Allows GOVERNMENT_ENTITY.CREATE.",
                        true,
                        "GOVERNMENT_ENTITY.CREATE",
                        "GOVERNMENT_ENTITY.CREATE",
                        null,
                    },
                    {
                        ...
                        "Allows GOVERNMENT_ENTITY.UPDATE.",
                        true,
                        "GOVERNMENT_ENTITY.UPDATE",
                        "GOVERNMENT_ENTITY.UPDATE",
                        null,
                    },
                    {
                        ...
                        "Allows GOVERNMENT_ENTITY.DELETE.",
                        true,
                    ...
                    },
                    {
                        ...
                        "Allows GOVERNMENT_ENTITY.RESTORE.",
                        true,
                        "GOVERNMENT_ENTITY.RESTORE",
                        "GOVERNMENT_ENTITY.RESTORE",
                        null,
                    },
                }
        ...
        {
            migrationBuilder.DropTable(name: "EntidadesGubernamentales");
