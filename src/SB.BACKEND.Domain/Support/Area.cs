...
{
    private Area() { }
    public Area(string nombre, string normalizado, string? descripcion) { Nombre = nombre; NombreNormalizado = normalizado; Descripcion = descripcion; }
    public string Nombre { get; private set; } = "";
    public string NombreNormalizado { get; private set; } = "";
    public string? Descripcion { get; private set; }
    public ICollection<SolicitudSoporte> Solicitudes { get; private set; } = new List<SolicitudSoporte>();
    public void Actualizar(string nombre, string normalizado, string? descripcion) { Nombre = nombre; NombreNormalizado = normalizado; Descripcion = descripcion; }
