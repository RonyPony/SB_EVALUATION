...
public sealed class ComentarioSolicitud : AuditableEntity
{
    ...
    { SolicitudId = solicitudId; UsuarioId = usuarioId; Contenido = contenido; EsInterno = interno; }
    public Guid SolicitudId { get; private set; } public SolicitudSoporte Solicitud { get; private set; } = null!;
    public Guid UsuarioId { get; private set; } public string Contenido { get; private set; } = ""; public bool EsInterno { get; private set; }
    public void Editar(string contenido) { if (IsDeleted) throw new InvalidOperationException(); Contenido = contenido; }
