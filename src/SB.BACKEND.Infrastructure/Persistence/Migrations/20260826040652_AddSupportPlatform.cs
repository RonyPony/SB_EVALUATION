        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreNormalizado = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenciaEvidencia = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    FechaCompromiso = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    FechaAsignacion = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    FechaInicioAtencion = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    ComentarioResolucion = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "SolicitudId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "SolicitudesSoporte",
                columns: new[] { "IsDeleted", "Estado", "Prioridad" });
